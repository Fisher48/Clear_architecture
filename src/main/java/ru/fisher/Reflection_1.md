...
Минусы данного подхода вы описали верно, если начать усложнять структуру робота или добавлять много взаимосвязей с другими вещами, то
одними if-else в цикле не обойтись и получится полная неразбериха.
